...
import { storage } from '../src/cache/ComponentCache'
...
describe('Add Children action: ', function() {
  it('should have a type of ADD_CHILDREN ', function() {
    expect(Actions.addInChildren().type)
      .to.equal('ADD_CHILDREN');
  })

  // it('should add a new component into storage', function() {
  //   expect(storage)
